...
<!-- END: ROW_ITEMS -->
						<td class="centerall"><a title="{PHP.L.Open}" href="{ADMIN_RIGHTSBYITEM_ROW_JUMPTO}" class="btn special">{PHP.L.Open}</a><a title="{PHP.L.Open}" href="{ADMIN_RIGHTSBYITEM_ROW_LINK}" class="btn btn-default">{PHP.L.Rights}</a> </td>
