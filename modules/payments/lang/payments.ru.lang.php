...
$L['cfg_transfermin'] = array('Минимальная сумма перевода между пользователями', cot::$cfg['payments']['valuta']);
$L['cfg_transfermax'] = array('Максимальная сумма перевода между пользователями', cot::$cfg['payments']['valuta']);
...
$L['cfg_payoutmin'] = array('Минимальная сумма для вывода со счета', cot::$cfg['payments']['valuta']);
$L['cfg_payoutmax'] = array('Максимальная сумма для вывода со счета', cot::$cfg['payments']['valuta']);
