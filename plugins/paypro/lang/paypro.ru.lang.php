...
$L['paypro_warning_projectslimit_empty'] = 'Вы больше не можете публиковать проекты. Максимальное число проектов для публикации составляет: '.cot::$cfg['plugin']['paypro']['projectslimit'].' в сутки. Чтобы снять это ограничение, воспользуйтесь услугой PRO-аккаунт.';
$L['paypro_warning_offerslimit_empty'] = 'Вы больше не можете оставлять предложения по проектам. Максимальное число откликов на проекты составляет: '.cot::$cfg['plugin']['paypro']['offerslimit'].' в сутки. Чтобы снять это ограничение, воспользуйтесь услугой PRO-аккаунт.';
